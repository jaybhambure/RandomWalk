...
public:
    ...
    PetscErrorCode uniform(Vec &vec, PetscInt gridSize) {
        PetscFunctionBegin;
        PetscScalar *array;
        PetscInt localStart, localEnd;
        VecGetOwnershipRange(vec, &localStart, &localEnd);
    ...
    PetscErrorCode gaussian(Vec &vec, PetscInt gridSize) {
        PetscFunctionBegin;
        PetscScalar *array;
        PetscInt localStart, localEnd;
        VecGetOwnershipRange(vec, &localStart, &localEnd);
    ...
    PetscErrorCode clustered(Vec &vec, PetscInt gridSize) {
        PetscFunctionBegin;
        PetscScalar *array;
        PetscInt localStart, localEnd;
        VecGetOwnershipRange(vec, &localStart, &localEnd);
    ...
    PetscErrorCode random_sparse(Vec &vec, PetscInt gridSize) {
        PetscFunctionBegin;
        PetscScalar *array;
        PetscInt localStart, localEnd;
        VecGetOwnershipRange(vec, &localStart, &localEnd);
